...
1) clone the repo
* After clonning the repo, you have to add the db connnection string in db.py and the director account password in call_auth_endpoint() function in views .py. You can find them in the teamBuilder chat in discord.
2) cd to teamRU
